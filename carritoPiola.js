...
$(document).ready(function () {
    //cambios en el dom
    $("#boton").prepend(
        "<button class='btn btn-warning' id='btnSuscrip'>Suscribirse a Prato</button>"
    ); //poner como primer hijo
...
function renderizarProductos() {
    for (const producto of productos) {
        $(".milista")
            .append(`<li class="list-group-item cards borderBlanco" id='cardsId'><h3 class='boxmodCentrar'> ${producto.nombre}</h3>
...
function suscribir() {
    ...
    $("#miFormulario").submit(function (e) {
        ...
        Swal.fire("Nueva suscripcion", $("#email").val(), "success");
